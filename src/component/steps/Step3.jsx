...
function Step3({onReturnHome}) {
  return (
    <div className=' w-full h-screen  flex flex-col justify-center items-center gap-6'>
          <div className='w-[520px] h-[362px]   bg-white text-center'> 
            <div className='w-[520px] h-[104px] flex justify-center'>
                <div className='h-[104px] w-[104px] bg-[#E5E7EB]'></div>
            </div>
            <div className='w-[520px] h-[78px] flex justify-center '>
                  <div className='w-[520px] h-[78px]'>
                    <h4 className='font-Lato font-semibold text-[28px] leading-[39px] text-center text-[#051011]'>Your Request for a Proposal Has Been Submitted!</h4></div>
            </div>
            <div className='w-[520px] h-[78px]'>
