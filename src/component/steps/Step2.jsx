...
function Step2({ formData, setFormData, nextStep, prevStep }) {
  ...
  return (
    <div className='w-[520px] h-screen top-[199.5px] left-[460px] gap-[48px]'>
      <div className='w-[520px] h-[150px] flex flex-col gap-3'>
        <div className='w-[520px] h-[39px]'>
      ...
      <div className='w-[520px] h-3/4 mt-14'>
        <form className='flex flex-col gap-[32px]' onSubmit={handleSubmit(onSubmit)}>
          <div className='w-[520px] h-[294px] flex flex-col gap-[16px]'>
            <div className='w-[520px] h-[66px]'>
              ...
              <input
                type='text'
                name='name'
                className='w-[520px] h-[48px] rounded-[3px] border-[#E5E7EB] border border-solid'
                {...register('name', { required: 'Name is required' })}
              />
              {errors.name && <p className='text-red-500'>{errors.name.message}</p>}
            </div>
            <div className='w-[520px] h-[66px] flex gap-4'>
              <div className='w-[252px] h-[66px]'>
                ...
                <input
                  type='email'
                  name='email'
                  className='w-[252px] h-[48px] rounded-[3px] border-[#E5E7EB] border border-solid'
                  {...register('email', {
            ...
            <div className='w-[252px] h-[130px]'>
              ...
              <textarea
                name='message'
                className='font-Lato w-[520px] h-[112px] rounded-[3px] border-[#E5E7EB] border border-solid'
                {...register('message',{required:true})}
              ></textarea>
              {errors.message && <p className='text-red-500'>{errors.message.message}</p>}
            </div>

            <div className='w-[520px] h-[48px] mt-6 text-center'>
              <button type='submit' className='w-[160px] h-[48px] font-Lato font-semibold leading-[16px] text-[15px] text-[#FFFFFF] bg-[#019F44]'>
                Send Request
              </button>
            </div>
            <div className='w-[520px] h-[48px] mt-6 flex justify-center'>
